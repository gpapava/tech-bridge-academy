            ...
            <div className="max-w-3xl">
              ...
              {!isAuthenticated && (
                <div className="mt-8 flex gap-3">
                  ...
                  <Link href="/auth/login" className="text-blue-100 hover:text-white underline self-center text-sm">Already registered? Sign in</Link>
                </div>
              )}
            </div>
          </div>
              ...
              <div key={title} className="card p-6">
                ...
                {restricted ? (
                  <div className="flex items-center gap-2 text-sm text-slate-400">
                    ...
                    <Link href="/auth/register?role=SCHOOL" className="text-blue-600 hover:text-blue-700 font-medium">Register as School to access</Link>
                  </div>
                ) : (
                  <Link href={href} className="flex items-center gap-1.5 text-sm font-medium text-blue-700 hover:text-blue-900">
